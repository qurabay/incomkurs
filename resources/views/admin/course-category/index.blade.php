    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <a href="{{route('admin.category_course.create', $course->id)}}" class="btn btn-success btn-circle waves-effect waves-circle waves-float m-t--10 pull-right">
...
{{--                                    <td><img width="150px" src="{{asset($course->image)}}" alt=""></td>--}}
                                    <td>{{$course->title}}</td>
                                    <td>
                                        <a href="{{route('admin.lesson.index',$course->id)}}" class="m-t--10 waves-effect btn btn-primary">Уроки</a>
                                        <a href="{{route('admin.category_course.edit',$course->id)}}" class="waves-effect btn btn-success"><i class="material-icons">mode_edit</i></a>
                                        <a href="{{route('admin.category_course.destroy',$course->id)}}" class="waves-effect btn btn-danger"><i class="material-icons">delete</i></a>
                                        <a href="{{route('admin.category_course.beFirst',$course->id)}}" class="waves-effect btn btn-danger">Сделать первым</a>
